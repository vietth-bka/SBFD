...
def bbox_transform_inv_opr_lmk(bbox, deltas):
    ...
    pred_lmk_x1 = bbox_ctr_x + deltas[:, 4] * bbox_width
    pred_lmk_y1 = bbox_ctr_y + deltas[:, 5] * bbox_height
    pred_lmk_x2 = bbox_ctr_x + deltas[:, 6] * bbox_width
    pred_lmk_y2 = bbox_ctr_y + deltas[:, 7] * bbox_height
    pred_lmk_x3 = bbox_ctr_x + deltas[:, 8] * bbox_width
    pred_lmk_y3 = bbox_ctr_y + deltas[:, 9] * bbox_height
    pred_lmk_x4 = bbox_ctr_x + deltas[:, 10] * bbox_width
    pred_lmk_y4 = bbox_ctr_y + deltas[:, 11] * bbox_height
    pred_lmk_x5 = bbox_ctr_x + deltas[:, 12] * bbox_width
    pred_lmk_y5 = bbox_ctr_y + deltas[:, 13] * bbox_height
...
def bbox_transform_opr_lmk(bbox, gt):
    ...
    gt_lmk_x1, gt_lmk_y1 = gt[:,6], gt[:,7]
    gt_lmk_x2, gt_lmk_y2 = gt[:,8], gt[:,9]
    gt_lmk_x3, gt_lmk_y3 = gt[:,10], gt[:,11]
    gt_lmk_x4, gt_lmk_y4 = gt[:,12], gt[:,13]
    gt_lmk_x5, gt_lmk_y5 = gt[:,14], gt[:,15]
